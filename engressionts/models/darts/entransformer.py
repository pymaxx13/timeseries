...
class _EnTransformerModule(EngressionPLModule):
    ...
    def forward(self, x_in: PLModuleInput):
        ...
        # engression noise injection: applied immediately after unpacking the model
        # input, before any Transformer computation begins
...
class EnTransformerModel(PastCovariatesTorchModel):
    ...
    def _create_model(self, train_sample: TorchTrainingSample) -> _EnTransformerModule:
