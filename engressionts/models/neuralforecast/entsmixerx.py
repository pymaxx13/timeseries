__all__ = ['TemporalMixing', 'FeatureMixing', 'MixingLayer', 'MixingLayerWithStaticExogenous', 'EnTSMixerx']
...
class EnTSMixerx(NFEngressionBaseModel):
    """EnTSMixerx
    ...
    def forward(self, windows_batch):
        ...
        x = self.noise_layer(x)  # Stochastic Noise Injection Point!
