...
class EnxLSTM(NFEngressionBaseModel):
    """EnxLSTM
    ...
    def __init__(
        ...
        **trainer_kwargs
        ...
        if not IS_XLSTM_INSTALLED:
            raise ImportError(
                "Please install `xlstm`. You also need to install `mlstm_kernels` for backbone='mLSTM' and `ninja` for backbone='sLSTM'."
            )
    ...
    def forward(self, windows_batch):
        ...
        encoder_input = self.noise_layer(encoder_input)  # Stochastic Noise Injection Point!
