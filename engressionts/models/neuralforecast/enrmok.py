__all__ = ['WaveKANLayer', 'TaylorKANLayer', 'JacobiKANLayer', 'EnRMoK']
...
class EnRMoK(NFEngressionBaseModel):
    ...
    def __init__(
        ...
        **trainer_kwargs
        ...
        # Fixed Bug: Original RMoK code forwarded exog lists incorrectly:
        # futr_exog_list=hist_exog_list, hist_exog_list=stat_exog_list, stat_exog_list=futr_exog_list
        super().__init__(
            h=h,
