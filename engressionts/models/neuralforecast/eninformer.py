__all__ = ['ConvLayer', 'ProbMask', 'ProbAttention', 'EnInformer']
...
class EnInformer(NFEngressionBaseModel):
    """EnInformer

        The EnInformer model tackles the vanilla Transformer computational complexity challenges for long-horizon forecasting.
    ...
    def forward(self, windows_batch):
        ...
        insample_y = self.noise_layer(insample_y)  # Stochastic Noise Injection Point!
